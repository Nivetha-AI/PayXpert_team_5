...
public class MPayrollController {
	...
	public static void main(String[] args) {
		...
		while(true)
		{
			...
			System.out.println("Press 3. GetPayrollsForPeriod");
			System.out.println("Press 4. Add Payroll Record");
			...
			switch(input)
			{
				...
				case 4:
					...
					try {
						...
						System.out.println("Payroll record created");
					} catch (SQLException e) {
						System.out.println(e.getMessage());
					}
					break;
