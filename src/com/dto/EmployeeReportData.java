...
public class EmployeeReportData {
	...
	public String toString() {
		return "EmployeeReportData [id=" + id + ", FirstName=" + firstName + ", LastName=" + lastName
				+ ", taxableIncome=" + taxableIncome + ", taxYear=" + taxYear + ", taxAmount=" + taxAmount
				+ ", RecordDate=" + recordDate + ", RecordType=" + recordType + ", amount=" + amount + "]";
	}
	...
	public boolean equals(Object obj) {
		...
		return Double.doubleToLongBits(amount) == Double.doubleToLongBits(other.amount)
				...
				&& Objects.equals(lastName, other.lastName) && Objects.equals(recordDate, other.recordDate)
