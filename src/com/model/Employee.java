...
public class Employee {
	...
	public String toString() {
		return "Employee [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", dateOfBirth="
				+ dateOfBirth + ", gender=" + gender + ", email=" + email + ", PhoneNum=" + phoneNum + ", Address="
				+ address + ", Position=" + position + ", JoiningDate=" + joiningDate + ", TerminationDate="
				+ terminationDate + "]";
	}

	@Override
	public int hashCode() {
		return Objects.hash(address, dateOfBirth, email, firstName, gender, id, joiningDate, lastName, phoneNum,
				position, terminationDate);
	}
	...
	public boolean equals(Object obj) {
		...
		return Objects.equals(address, other.address) && Objects.equals(dateOfBirth, other.dateOfBirth)
				...
				&& Objects.equals(phoneNum, other.phoneNum) && Objects.equals(position, other.position)
